...
| `mmseqs_max_sequence_coverage` | The threshold of sequence coverage above which two sequences are clustered, given sufficient sequence identity. <br/>A sequence contained to at least this percentage in another is clusterd to that one.                       | 0.8                                                            |
