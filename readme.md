...
| `tmbed_model_path`         | Add a value to specify a directory where TMbed shall store its ProtT5 model persistently. <br/>If no value is set, TMbed will download the model each time it is executed.  <br/> **TMbed will only recognise relative paths for this setting.**                        | (none)                                                         |
